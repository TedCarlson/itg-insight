...
export type CompanyManagerHeaderModel = {
...
type Props = {
  header: CompanyManagerHeaderModel;
};
...
export default function CompanyManagerHeader({ header }: Props) {
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="text-[11px] uppercase tracking-wide text-muted-foreground">
            {header.role_label ?? "Company Manager"}
          </div>
